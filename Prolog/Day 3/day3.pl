pretty_print([]).
pretty_print(Puzzle) :- pretty_print(1, Puzzle).

pretty_print(4, Puzzle) :- 
  write('---------------------\n'), 
  pretty_print(5, Puzzle).
pretty_print(8, Puzzle) :- 
  write('---------------------\n'), 
  pretty_print(9, Puzzle).

pretty_print(N, [Col1, Col2, Col3, Col4, Col5, Col6, Col7, Col8, Col9 | Puzzle]) :- 
  member(N, [1,2,3,5,6,7,9,10,11]),
  format('~d ~d ~d │ ~d ~d ~d │ ~d ~d ~d~n', [Col1, Col2, Col3, Col4, Col5, Col6, Col7, Col8, Col9]), 
  N1 is N + 1,
  pretty_print(N1, Puzzle).
